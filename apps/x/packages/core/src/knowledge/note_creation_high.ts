...
## 9c: Emails — Update Existing Notes Only
...
## From web browsing
{Entries from browsed web pages relevant to this person. Leave empty if none.}
...
## From web browsing
{Entries from browsed web pages relevant to this organization. Leave empty if none.}
- **{YYYY-MM-DD}**: {Brief description} — {URL}
...
## From web browsing
{Entries from browsed web pages relevant to this project. Leave empty if none.}
- **{YYYY-MM-DD}**: {Brief description} — {URL}
...
## From web browsing
{Entries from browsed web pages relevant to this topic. Leave empty if none.}
- **{YYYY-MM-DD}**: {Brief description} — {URL}
